...
if(t)return a.createDocumentFragment();d=d||f(a);for(var e=d.frag.cloneNode(),g=0,h=c(),k=h.length;g<k;g++)e.createElement(h[g]);return e}};a.html5=u;k(b)})(this,e);f._version="2.8.3";f._prefixes=s;f._domPrefixes=F;f._cssomPrefixes=E;f.mq=function(a){var b=h.matchMedia||h.msMatchMedia;if(b)return b(a)&&b(a).matches||!1;var c;p("@media "+a+" { #modernizr { position: absolute; } }",function(a){c="absolute"==(h.getComputedStyle?getComputedStyle(a,null):a.currentStyle).position});return c};f.hasEvent=
I;f.testProp=function(a){return D([a])};f.testAllProps=c;f.testStyles=p;f.prefixed=function(a,b,e){return b?c(a,b,e):c(a,"pfx")};l.className=l.className.replace(/(^|\s)no-js(\s|$)/,"$1$2")+(" js "+y.join(" "));return f}(this,this.document);
